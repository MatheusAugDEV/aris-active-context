...
O artifact `artifacts/purgatorium/purg_pre_route_opening_candidate.json` foi criado para registrar a abertura desejada de `PURG-PRE`, mas a rota viva permanece `IF-08` porque schema e validator ainda operam em fail-closed para essa mutacao.
