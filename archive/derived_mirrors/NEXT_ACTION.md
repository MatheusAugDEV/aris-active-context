...
Esta fase executa somente a verificacao/materializacao de autoridade de `PURG-PRE`; nao abrir `PURG-00`, nao corrigir finding, e nao tocar audio real, STT/TTS real, microfone, runtime real, MCP real, secrets, rede externa ou real_apply nesta fase.
