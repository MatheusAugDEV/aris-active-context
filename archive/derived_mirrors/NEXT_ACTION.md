...
Esta fase prepara somente o pacote de operator review para futura admissao de rota de `PURG-00`; nao abrir `PURG-00`, nao executar intake, nao corrigir finding, e nao tocar audio real, STT/TTS real, microfone, runtime real, MCP real, secrets, rede externa ou real_apply nesta fase.
