...
Esta fase admite somente a rota viva de `PURG-00`; nao executar `PURG-00`, nao executar intake, nao corrigir finding, e nao tocar audio real, STT/TTS real, microfone, runtime real, MCP real, secrets, rede externa ou real_apply nesta fase.
