...
def main() -> None:
    ...
    _require(state["status"] == "lab_real_simulation_pack_controlled_apply_dry_run_evidence_routes_readiness_consolidation_gate_pass", "unexpected status")
    _require(state["decision"] == "pass", "unexpected decision")
    _require(state["latest_completed_phase"] == "Lab Real Simulation Pack Controlled Apply Dry-Run Evidence Routes Readiness Consolidation Gate", "unexpected latest completed phase")
    _require(state["current_status"] == "ready_for_controlled_apply_dry_run_evidence_routes_final_readiness_review_gate", "unexpected current status")
    _require(state["active_next_phase"] == "Lab Real Simulation Pack Controlled Apply Dry-Run Evidence Routes Final Readiness Review Gate", "unexpected next phase")
    ...
    _mirror_contains(
        ...
        "lab_real_simulation_pack_controlled_apply_dry_run_evidence_routes_readiness_consolidation_gate_pass",
        "ready_for_controlled_apply_dry_run_evidence_routes_final_readiness_review_gate",
    ...
    _mirror_contains(
        ...
        "Lab Real Simulation Pack Controlled Apply Dry-Run Evidence Routes Final Readiness Review Gate",
        "Readiness consolidation next-route contract",
    )
    _mirror_contains(
        ROOT / "ARIS_PHASE_LEDGER.md",
        ...
        json.dumps(
            {
                ...
                "review_result": "evidence routes readiness consolidation gate pass",
            },
            indent=2,
        )
    )
