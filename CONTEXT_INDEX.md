...
## New artifacts
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_gate_decision.json`
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_gate_summary.json`
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_plan_applied.json`
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_diff_manifest.json`
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_post_hashes.json`
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_token_delta.json`
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_rollback_package.json`
- `artifacts/context/artifact_reference_only_controlled_apply_rerun_gate_report.md`
