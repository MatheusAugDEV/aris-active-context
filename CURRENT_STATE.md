...
- F32.Z10 controlled apply dry-run authorization gate is stale after F32.Z8R and F32.Z9R; the previously accepted warning must rerun as F32.Z10R before any F32.Z11 path.
...
- F32.Z9R controlled apply plan review gate rerun completed; the Z8R-repaired plan remains safe, the prior Z10 acceptance is now stale and must rerun, and F32.Z10R — Future MCP Read-Only Configuration Controlled Apply Dry-Run Authorization Gate Rerun is next principal phase.
