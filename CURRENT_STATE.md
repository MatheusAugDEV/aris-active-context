...
- production_activation_allowed: `False`
- bedrock_real_execution_allowed: `False`
- resume_track: `F21B preserved track`
...
- closed_verdict_class: `scope_limited_pass`
- closure_scope: `technical_scope_limited_only`
- scope_limited_closure_preserved: `True`
...
- f21b_paused_track_preserved: `True`
- f21_a61_blocked: `True`
- next_real_action_from_locks: `F21-A61 — ARIS Lean Development Protocol v0.1 Prompt Kernel Minimal Contract Controlled Implementation Gate`
- blocker_count: `0`
- warning_count: `3`
- warnings:
...
- source_site_claims_status: `bedrock_gate_site_claims_full_audit_controlled_execution_pass`
- source_site_claims_decision: `pass`
- source_reviewed_evidence_bundle_complete: `True`
...
- warnings:
  - `R49R reconciled the missing root package and the ledger warning is carried forward explicitly.`
  - `The re-dry-run is controlled only; no real evidence bundle execution occurs here.`
  - `The four accepted gaps remain planned and pending execution.`
  - `R45-R48 remain formal plans and do not count as executed evidence.`
  - `R51 review gate is the next conservative step.`
- blockers:
  - `[]`
