...
- F32.Z10 controlled apply dry-run authorization gate is warn-passed; the Z9 coverage warning was accepted for future dry-run planning only, Z8 remained plan-only and safe, and F32.Z11 — Future MCP Read-Only Configuration Controlled Apply Dry-Run Simulation is next principal phase.
