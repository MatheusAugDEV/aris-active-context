...
git -C aris-active-context rev-parse HEAD
git -C aris-active-context rev-parse origin/main
git -C aris-active-context status --short
python3 -m py_compile src/aris/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning.py
python3 -m py_compile scripts/run_lab_real_simulation_pack_debian_disposable_harness_planning.py
python3 -m py_compile tests/test_lab_real_simulation_pack_debian_disposable_harness_planning.py
python3 -m unittest tests.test_lab_real_simulation_pack_debian_disposable_harness_planning -q
python3 scripts/run_lab_real_simulation_pack_debian_disposable_harness_planning.py
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning.json
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning_summary.json
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_contract.json
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_plan.json
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_boundary_matrix.json
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_risk_register.json
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_stop_conditions.json
python3 -m json.tool artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_evidence_index.json
grep -R -n -E 'Lab Real Simulation Pack Debian Disposable Harness Planning|ready_for_debian_disposable_harness_readiness_review|Lab Real Simulation Pack Debian Disposable Harness Readiness Review|Lab Real Simulation Pack Controlled Apply Operator Approval Packet Review|deferred|H4/H5/Hx not active current route|GitHub active-context is the only canonical active-context source\.|No GitHub active-context sync = no canonical PASS\.|Every ARIS phase/gate/status transition must update GitHub active-context\.|Every ARIS phase/gate/status transition must commit, push, and verify GitHub active-context\.|B001_markdown_as_runtime_state|B002_missing_strict_canonical_json_contract|B003_float_values_in_state_envelope|B004_missing_state_drift_gate|B005_approval_packet_text_not_contract|B006_rollback_paradox_unmitigated|B007_missing_shadow_workspace|B008_missing_saga_pivot_compensation|B009_dry_run_host_side_effect_not_proven_absent|B010_missing_atomic_commit_cas_protocol|B011_missing_filesystem_escape_threat_model|B012_missing_debian_disposable_harness' aris-active-context/CURRENT_STATE.md aris-active-context/NEXT_ACTION.md aris-active-context/DECISION_LOCKS.md aris-active-context/CONTEXT_INDEX.md aris-active-context/ARIS_PHASE_LEDGER.md aris-active-context/README.md artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning_summary.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_contract.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_plan.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_boundary_matrix.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_risk_register.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_stop_conditions.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_evidence_index.json || true
grep -R -n -E 'approved_for_real_apply|ready_for_real_apply|approved_for_runtime_change|approved_for_network_use|approved_for_secret_access|approved_for_dependency_change|approved_for_external_llm_call|approved_for_network_socket_open|approved_for_container_execution|approved_for_harness_execution|ready_for_real_dry_run_execution' src/aris/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning.py artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning_summary.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_contract.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_plan.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_boundary_matrix.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_risk_register.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_stop_conditions.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_evidence_index.json || true
grep -R -n -E 'docker|podman|apt|dpkg' src/aris/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning.py artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_planning_summary.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_contract.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_plan.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_boundary_matrix.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_risk_register.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_stop_conditions.json artifacts/lab_simulation/lab_real_simulation_pack_debian_disposable_harness_evidence_index.json || true
...
git diff -- aris-active-context
git show --name-only --stat --oneline HEAD
git -C aris-active-context show --name-only --stat --oneline HEAD
