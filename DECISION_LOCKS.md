...
- Apply planning keeps `real_apply_authorized=false`, `apply_execution_allowed=false`, `fixture_materialization_allowed=false`, and future human approval requirements non-bypassable.
...
- Controlled fixture apply planning does not authorize or execute apply and does not create fixtures.
...
- No Bedrock authorization by apply planning.
