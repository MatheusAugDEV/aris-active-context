...
class TestCanonicalState(unittest.TestCase):
    def test_canonical_state_passes(self) -> None:
        ...
        self.assertEqual(data["latest_completed_phase"], "ARIS Infernus Lab FULL 13-Bot Contract Pack Planning Gate")
        self.assertEqual(data["active_next_phase"], "ARIS Infernus Lab FULL Bot Scenario Interface Planning Gate")
