...
- simulated_surfaces_count: `0`
- rollback_entries_count: `0`
- warning_count: `8`
- blocker_count: `10`
...
next_phase: `null`
note: This phase_id uses a different numbering scheme than the P15-P19 sequence above (Infernus/Purgatorium era schema). The P15-P19 sequence and its P20 recommendation were superseded by this schema change and were never executed under the old numbering. See ACTIVE_CONTEXT_STATE.json last_resolved_divergence for the most recent resolved work (Lapidarium rebase/divergence repair).
