...
| LAPIDARIUM | pass | LAPIDARIUM_FASE_3_LIMPEZA_CACHE_GERADO | lapidarium_remediation | operator | lapidarium cursor activation decision + phase 3 cache cleanup inventory + bootstrap sync |
