...
- The consolidation gate passed by joining the broader operator-approval evidence route without authorizing any real behavior.
...
3. Preserve the blocked-history semantics and the residual warning register during route final-review work.
4. Only then proceed with `Lab Real Simulation Pack Controlled Apply Dry-Run Operator Approval Evidence Route Final Review Gate`.
