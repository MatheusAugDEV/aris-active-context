...
- Decision dependency: `Lab Real Simulation Pack Evidence Packaging Plan = pass`
...
- Objective: define the controlled apply planning envelope for consuming the packaged Lab evidence, without executing runtime or pilot surfaces.
