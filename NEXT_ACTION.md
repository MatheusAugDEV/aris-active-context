...
## Lab Real Simulation Pack Scenario Manifest Plan

- Status: `ready_for_next_subphase`
- Decision dependency: `Lab Real Simulation Pack Design Brief Alignment Gate = pass`
...
- Objective: align the scenario manifest contract for the Lab Real Simulation Pack without executing runtime or pilot surfaces.
