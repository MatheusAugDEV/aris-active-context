...
Canonical roadmap preference: phase-by-phase organization with subtracks inside each phase (`F29.A`, `F29.B`, `F29.C`, `F29.D`), then continue numerically with `F30`, `F31`, `F32`, and so on. F31.C now points to F31.D — Source-of-Truth Drift Repair Plan.
