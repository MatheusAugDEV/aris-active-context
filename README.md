...
F32.V now points to F32.W — Future MCP Read-Only Configuration Apply Dry-Run Execution Plan Review Gate, and F32.X now points to F32.Y — Future MCP Read-Only Configuration Dry-Run Execution Authorization Review Gate.
