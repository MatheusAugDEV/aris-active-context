...
## Estado canônico atual (HISTORICAL_ONLY — SUPERSEDED_BY_LAPIDARIUM_FASE_6_GUARDA_TRUE — NOT_CURRENT_STATE)

> Este bloco descreve um snapshot histórico (IF09 closure milestone). Para o estado vivo atual, ver "## Current snapshot" no topo deste arquivo e `ACTIVE_CONTEXT_STATE.json`.
